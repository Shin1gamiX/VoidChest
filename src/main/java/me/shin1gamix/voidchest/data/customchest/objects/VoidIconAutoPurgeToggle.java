...
public class VoidIconAutoPurgeToggle extends VoidIcon {
	...
	public VoidIconAutoPurgeToggle(final VoidStorage voidStorage, final ItemStack item, final int slot) {
	...
	public void execute(Player player) {
		...
		voidStorage.setPurgeInvalidItems(!voidStorage.isPurgeInvalidItems());
		voidStorage.update();
	}
