...
public class VoidIconVoidInventory extends VoidIcon {

	public VoidIconVoidInventory(final VoidStorage voidStorage, final ItemStack item, final int slot) {
	...
	public void execute(Player player) {
		...
		player.openInventory(voidStorage.getCustomInventory());
	}
