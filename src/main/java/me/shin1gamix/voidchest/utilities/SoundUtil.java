...
public enum SoundUtil {
	...
	HICKEN_WALK("CHICKEN_WALK", "ENTITY_CHICKEN_STEP"),
	...
	SoundUtil(String... versionDependentNames) {
	...
	public static Optional<org.bukkit.Sound> bukkitSound(String input) {
		if (input == null) {
			return Optional.empty();
		}
		for (SoundUtil sound : values()) {
			for (String name : sound.versionDependentNames) {
				if (name.equalsIgnoreCase(input)) {
					return Optional.of(sound.bukkitSound());
				}
			}
		}
		return Optional.empty();
