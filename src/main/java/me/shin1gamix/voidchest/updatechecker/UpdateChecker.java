package me.shin1gamix.voidchest.updatechecker;
...
public final class UpdateChecker {
	...
	private static final String USER_AGENT = "Shin1gamiX-update-checker";
	...
	/**
	 * Get the last update result that was queried by {@link #requestUpdateCheck()}.
	 * If no update check was performed since this class' initialization, this
	 ...
	 *            For example,
	 *            "https://www.spigotmc.org/resources/veinminer.<b>65576</b>/" would
	 *            expect "65576" as a value. The value must be greater than 0
	 * @param versionScheme
